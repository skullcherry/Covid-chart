...
function showAgain(){
    ...
    chart.data.datasets[0].data[0] = sessionStorage.getItem('recovered')
    chart.data.datasets[0].data[1] = sessionStorage.getItem('critical')
    chart.data.datasets[0].data[2] = sessionStorage.getItem('dead')
...
function renderHTML(dataFromAPI){
    ...
    sessionStorage.setItem('recovered', dataFromAPI[0].recovered)
    sessionStorage.setItem('critical', dataFromAPI[0].critical)
    sessionStorage.setItem('dead', dataFromAPI[0].deaths)
...
//datele preluate din api sunt stocate in memoria de sesiune
